...
[A video solution of this exercise is available here](https://www.youtube.com/watch?v=qodtfXR9RIQ). Make sure you've attempted it first.
...
A sequence of numbers is also a collection — in Kotlin, [we can use a Range](https://kotlinlang.org/docs/ranges.html) to create a collection which is a list of numbers from a low bound to a high bound.
